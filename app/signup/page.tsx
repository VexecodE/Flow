...
export default async function SignupPage(props: { searchParams?: Promise<{ message?: string }> }) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-[#090909] bg-cover bg-center" style={{ backgroundImage: "url('/login_bg.jpg')" }}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 max-w-6xl w-full items-center p-6 border border-white/5 rounded-3xl bg-white/5 backdrop-blur-sm z-10">
                ...
                <div className="max-w-md mx-auto lg:mx-0 w-full">
                    ...
                    <p className="text-lg leading-relaxed text-zinc-400 mb-8 text-center lg:text-left">
                        Start your journey to economic flow
                    </p>
                    ...
                    <div className="mt-8 text-center text-sm text-gray-500">
                        ...
                        <Link href="/login" className="text-blue-400 font-bold hover:text-blue-300 transition-colors underline underline-offset-4">
                            Sign In
                        </Link>
                    </div>
                ...
                <div className="relative hidden lg:block h-full">
                    <div className="h-[600px] flex items-end p-12 bg-[url(https://images.unsplash.com/photo-1709706696753-1dc4f13d0cc4?w=1080&q=80)] bg-cover bg-center rounded-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10 w-full">
                            ...
                            <h3 className="text-3xl font-normal text-white tracking-tight uppercase">Join the Ecosystem</h3>
                            <p className="text-gray-400 mt-2 max-w-sm">Scale your financial infrastructure with global reach and enterprise-grade security.</p>
                        </div>
                    </div>
                </div>
            </div>
